...
elif thisDSID >=410592  and thisDSID <=410595:
    model   = 'TopFCNC-onlyh'
    runName = 'mcttqHWb'+str(runArgs.runNumber)+'NLO5FS'
else : 
    raise RuntimeError("runNumber %i not recognised in these jobOptions, the model is not set."%runArgs.runNumber)
...
if not thisDSID >=410592  and thisDSID <=410595 :
    if wtyp == 0:
        wstr = ', w- > l- vl~'
    elif wtyp == 1:
        wstr = ', w+ > l+ vl'
...
# the tqH part
if (thisDSID >= 410700 and thisDSID <= 410779 or thisDSID >=410592  and thisDSID <=410595 ):
